...
\geometry{paperheight= auto, paperwidth= auto}
...
\begin{definition}
  ...
  ledger protocolsdfdsfdsfdsfdsf.
\end{definition}
...
{\state{{\algoreturn}$\phi${\END}}}

{\state{{\algoelse} }}

{\state{{\algoreturn}$E \in \mathcal{C}: H_n (E) = \max \{H_n (B') : B' \in
\mathcal{C}\}${\END}}}}}}}
